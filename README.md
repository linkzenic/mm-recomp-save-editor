...
The editor opens in-game and writes directly to the active save context. It is meant for quick testing, routing, restoration, and experimentation without leaving the game. Whenever possible backup save files before using a save editor!

## Features

- Edit name, Bombers code, day, time, time speed, intro-complete state, owl-save state, and more
...
- Keep a backup of game saves before testing large changes.
